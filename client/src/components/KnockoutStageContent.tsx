...
function KnockoutBracketVisualizer({
  ...
  function renderHorizCard(
    ...
    return (
      ...
      >
        <div style={{ width: slotW, height: cardH, overflow: 'hidden', background: homeProgressed ? 'radial-gradient(circle, rgba(234,179,8,0.35) 0%, transparent 75%)' : undefined, boxShadow: homeProgressed ? 'inset 0 0 0 1.5px #eab308' : undefined }} className="flex items-center justify-center flex-shrink-0">
          <VizTeamIcon team={home} size={iconSize} />
        </div>
        <div className="bg-border flex-shrink-0" style={{ width: 1 }} />
        <div style={{ width: slotW, height: cardH, overflow: 'hidden', background: awayProgressed ? 'radial-gradient(circle, rgba(234,179,8,0.35) 0%, transparent 75%)' : undefined, boxShadow: awayProgressed ? 'inset 0 0 0 1.5px #eab308' : undefined }} className="flex items-center justify-center flex-shrink-0">
