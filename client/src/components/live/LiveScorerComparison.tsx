...
//
// Two rankings of the same shortlist, side by side: the order the member submitted, and
// the order the goals have actually put the players in. Shown once the ranking has closed
// and somebody has scored — see LiveScorerPrediction for why it takes both.
//
