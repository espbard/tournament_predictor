...
const cls = 'mb-4 hidden sm:inline-flex items-center justify-center opacity-50 hover:opacity-100 dark:opacity-60 dark:hover:opacity-100 transition-opacity';
